...
const MovieProvider = ({ children }) => {
    ...
    return (
        <MovieContext.Provider value={{ movies: filteredMovies, setSearchQuery, setButtonSearchQuery, searchQuery }}>
            {children}
                ...
                <div className="w-3/5">
                    ...
                    <div className="relative flex">
                        ...
                        <input
                            type="search"
                            id="default-search"
                            className="block p-2 pl-10 w-60 text-sm text-gray-900 bg-gray-50 rounded-full border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div className="flex items-center">
                                <div className="relative mr-8">
                                    <input
                                        ...
                                        className="p-2 pl-10 w-46 rounded-full text-gray-600 font-xs"
                                        placeholder=""
                                    />
                                </div>
